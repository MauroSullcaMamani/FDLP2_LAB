...
public class VideoJuego4 {
    ...
    public static void inicializarEjercito(Soldado[][] tabla,ArrayList<Soldado> ejercito,int tipo){
        ...
        for (int i=0;i<numSoldados;i++){
            ...
            do {
                ...
                persona.setNombre("soldado"+" Vid."+persona.getVida()+" Ejer."+tipo);//Generamos el nombre del soldado
            }
    ...
    public static void mostrarEjercitoTabla(Soldado[][] tabla){
        ...
        for (int i=0;i<tabla.length;i++){
            System.out.print("|");
            for (int j=0;j<tabla[i].length;j++){
                    System.out.print(tabla[i][j].getVida()+" |");
            }
            System.out.println();
            System.out.println("|___|___|___|___|___|___|___|___|___|___|");
        }
